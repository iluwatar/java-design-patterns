...
<!-- the line below needs to be an empty line C: (it's because of kramdown is
...
experienced programmers and architects from the open-source community. The patterns can be browsed by their high-level descriptions or by looking at their
...
in your architecture and have as much fun learning them as we had to develop them.

# How to contribute

If you are willing to contribute to the project you will find the relevant information in our [developer wiki](https://github.com/iluwatar/java-design-patterns/wiki). We will help 
