...
//         final Optional<SubscriptionValidationEventData> queryBody = Optional.of(subscriptionValidationEventData);
//         doReturn(subscriptionValidationEventData).when(req).getBody();
